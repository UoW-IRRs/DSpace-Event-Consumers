 ...
 *
 * This consumer queues up the curation tasks given in the configuration file via queue.install7.tasks
 * (comma separated list) into the task queue named in the configuration file via queue.install7.name.
 *
 */
public class QueueTaskOnInstall7 extends QueueTaskOnEvent {

	@Override
	String getTasksProperty() {
		return "queue.install7.tasks";
	}

	@Override
	String getQueueProperty() {
		return "queue.install7.name";
	}
